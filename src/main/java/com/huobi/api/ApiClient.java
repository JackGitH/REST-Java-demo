...
public class ApiClient {
    ...
    static final String API_URL = "https://openapi.wbfex.com";
    ...
    public List<Symbol> getSymbols() {
        ApiResponse<List<Symbol>> resp =
                get("/open/api/common/symbols", null, new TypeReference<ApiResponse<List<Symbol>>>() {
                });
     ...
     * @return Order id.
     */
    public OrdersDetailResponse createOrder(CreateOrderRequest request) {
//        ApiResponse<Long> resp =
//                post("/v1/order/orders", request, new TypeReference<ApiResponse<Long>>() {
//                });
        OrdersDetailResponse resp =
                        post("/open/api/create_order", request, new TypeReference<OrdersDetailResponse>() {
                        });
        return resp;
    }
    ...
    public KlineResponse kline(String symbol, String period, String size) {
        ...
        map.put("size", size);
        KlineResponse resp = get("/open/api/get_records", map, new TypeReference<KlineResponse<List<Kline>>>() {
        });
        return resp;
    }
    ...
    public MergedResponse merged(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        MergedResponse resp = get("/open/api/get_ticker", map, new TypeReference<MergedResponse<List<Merged>>>() {
        });
        return resp;
    }
